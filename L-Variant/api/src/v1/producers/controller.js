...
const { component_category, producers } = require('../utils/dictionary.js')

/**
 * GET      /api/v1/producers               -> getAll
 * POST     /api/v1/producers/              -> create
 * POST      /api/v1/producers/:id/start    -> start
 * POST      /api/v1/producers/:id/stop     -> stop
 * GET      /api/v1/producers/:id           -> getById
 * PUT      /api/v1/producers/:id/config    -> update
 * DELETE   /api/v1/producers/:id           -> remove
 */
...
function create(req, res) {
    ...
    const typeIndex = producers.indexOf(reqType)
    const type = producers[typeIndex]
